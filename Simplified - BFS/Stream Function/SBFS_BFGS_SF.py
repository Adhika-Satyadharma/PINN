...
N_r = 4500          # Interior
N = 1000000          # Epoch
Backup_Interval = [200, 1000, 3000, 5000, 10000, 20000, 30000, 40000, 50000, 100000, 200000, 300000, 500000, 800000]
Speical_LF = []
BFGS_Criteria = ["iter", 1000000]
...
CD = Channel_Flow(                           # Initialize Case
    [0., 30., -1., 1.],                                      # Domain (Main axis = x axis in image)
...
# Failsafe
if NN_Solver.iter - Adam_Iter < 1000:
    print("Switch back to Adam")
    Adam_Iter2 = NN_Solver.solve_with_TFoptimizer(xbi_data, ubi_data, N-NN_Solver.iter, Print_Every, t0, ["LS", 1e-30])
